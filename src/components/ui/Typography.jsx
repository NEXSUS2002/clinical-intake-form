...
export const Label = ({ children, required, htmlFor }) => (
  <label
    htmlFor={htmlFor}
    className="block text-sm font-semibold text-navy tracking-wide mb-1"
  >
    {children}
...
export const Hint = ({ children }) => (
  <p className="text-[13px] text-slate-dim italic mb-1.5 leading-relaxed">
    {children}
  </p>
);
...
export const ErrorMessage = ({ message }) => {
  ...
  return (
    <p className="flex items-center gap-1 text-sm font-medium text-error mt-1.5">
...
export const InfoBox = ({ children, variant = "teal" }) => (
  <div
    className={`rounded-xl p-4 mb-4 ${INFO_VARIANTS[variant] || INFO_VARIANTS.teal}`}
  >
    {children}
  </div>
);
